...
1. [公司概览](/docs/company/overview) — 我们是谁、做什么、核心技术判断
2. [产品路线图](/docs/company/roadmap) — 当前阶段目标和本季度里程碑
3. [系统架构总览](/docs/guides/system-architecture) — 七层技术架构和数据流
...
Vault 目录结构说明见 [知识管理协作方式](/docs/guides/knowledge-management)。
...
- 标注规范见 [EgoCentric 标注规范](/docs/references/egocentric-annotation)
- 蓝鸟云操作指南见 [蓝鸟云标注平台](/docs/references/laniao-cloud)
...
**数据标注 QA 标准是什么？**
参考 [EgoCentric 标注规范](/docs/references/egocentric-annotation) 中的质检标准和 17 项不合格原因代码。
