...
How CyberOrigin runs egocentric data collection at scale: calibration protocol, session structure, and metadata tracking.
...
- **Phase 1** (Jun-Jul 2025): Rented apartments — Longgang (Vanke Tianyu), Bao'an (Convention Bay South Bank), Guangming (Baisheng Shangfu)
